...
const userSchema = new Schema({
    firstName: {
        type: String, minLength: [3, 'First name must be at least 3 characterst long!'], validate: {
            validator(value) {
    ...
    lastName: {
        type: String, minLength: [, 'Last name must be at least 5 characterst long!'], validate: {
            validator(value) {
                return NAME_PATTERN.test(value);
            },
